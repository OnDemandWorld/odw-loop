 ...
 */
import type { Workflow, WorkflowDefinition, WorkflowDefinitionVersion, WorkflowExecution, NodeExecution, WorkflowTrigger, Connector } from '@loop/types';
...
export interface StateStore {
    ...
    workflows: {
        ...
        list(filter: WorkflowFilter, pagination: PaginationParams): Promise<PaginatedResult<Workflow>>;
    ...
    workflowDefinitions: {
        ...
        getByWorkflowAndVersion(workflowId: string, version: number): Promise<WorkflowDefinitionVersion | null>;
    };
    executions: {
        create(data: {
            id: string;
        ...
        list(filter: ExecutionFilter, pagination: PaginationParams): Promise<PaginatedResult<WorkflowExecution>>;
